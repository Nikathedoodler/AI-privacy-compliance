  ...
  >
    ...
    <div className="flex space-x-4">
      <motion.button
        ...
        className="flex items-center gap-2 px-4 py-3 bg-black text-white text-sm rounded-full font-semibold shadow-md shadow-black/80 hover:shadow-md hover:shadow-green-400 cursor-pointer transition-all duration-200 hover:scale-105 group"
      >
        <Image
